...
public class DamageNumberManager : MonoBehaviour
{
    ...
    public void Spawn(Vector3 enemyWorldPos, float damage, Color? colorOverride = null, HitFeedbackStrength feedbackStrength = HitFeedbackStrength.Standard)
    {
        ...
        dn.Show(spawnPos, damage, colorOverride, feedbackStrength);
    }
}
