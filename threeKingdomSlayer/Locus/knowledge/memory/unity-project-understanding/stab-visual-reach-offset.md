...
- `Zhangfei_Stab.asset` currently uses `0.5f` as the first calibration pass.
...
Relevant files: `Assets/Scripts/Core/AttackSkillConfig.cs`, `Assets/Scripts/Attack/StabSweepEffect.cs`, `Assets/Scripts/Player/AttackSystem.cs`.
<!-- locus:body:end -->
