...
type: memory
path: normal-enemy-health-status-bar.md
title: normal-enemy-health-status-bar
inheritInjectMode: true
summaryEnabled: true
commandEnabled: false
readOnly: false
inheritAiConfig: true
createdAt: 1785297044409
updatedAt: 1785297044410
---

# normal-enemy-health-status-bar

## Summary
普通敌人生命/状态条统一由 EnemyHealthBar.barWidth 控制；当前验收宽度为1.0。
